/*
	...
	label strip, recessed LCD readout. Shared RackSkinDetail primitives handle
	the repeated lamp hardware; this file owns widget state and elidable printing.
...
// A bezel-set panel LED painted by RackSkinDetail. The reference's health is read
