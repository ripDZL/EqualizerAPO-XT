...
{
	return styleSheetForTokens(id, dark, tokens(resolveId(id), dark), sourceDirectory);
}

ResolvedStyleSheet styleSheetForTokens(const QString& id, bool dark, const SkinTokens& themeTokens,
