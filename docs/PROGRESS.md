...
- [x] Pushed the isolated #265/#271 tree as `740a86e` and manually dispatched hosted Build EqualizerAPO run `31711097531`; it is the required cross-variant and offscreen UI gate before manual real-host acceptance. `beta`, `main`, and the active runtime remain untouched.
