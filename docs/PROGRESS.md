...
- [x] 2026-09-03 prepared isolated upstream `v2.51.0` candidate `codex/upstream-2510-integration`: tagged `3e595dc8` plus upstream release stamp `4c28c2cf` are merged over beta `3b6657c5`; unreleased `74fd96ec` stays separate. Conflict resolutions retain fork VST preview/theme behavior and add upstream’s Minimal vertical register-drum/font work. Green local checks: Pester 126/126; EditorLogic 4,585; HybridConv 1,635; Engine 1,320; Asio 447; source/skin gates; Qt VST and VST3-panel self-tests; dark/light knob visual inspection. v143 is a local preflight only because CI v145 is unavailable; AudioRegression goldens are absent and remain unvalidated. No remote, release, installer, runtime, or audio-service change. Next: explicit candidate install-test approval before beta promotion.
