...
- [x] Pushed the isolated #265/#271 tree as `740a86e`; hosted Build EqualizerAPO run `31711097531` passed all native variants, offscreen UI gates, Pester, cppcheck, and cross-variant comparison. Its initial AVX2 skin-switch 5.497 s outlier did not reproduce on the unchanged failed-job retry (worst 2160 ms against the same 5000 ms limit). `beta`, `main`, and the active runtime remain untouched; manual real-host acceptance is next.
