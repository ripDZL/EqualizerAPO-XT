...
- Next: manually validate a VST3 bundle import/load plus Theme Lab and LegacyRows persistence in an integration candidate, then run CI before any beta promotion.
