...
- Next: run CI (including Pester 5 build-script tests), then manually validate VST2 no-editor panel safety, VST3 bundle import/load, Theme Lab, and LegacyRows persistence in an integration candidate before any beta promotion.
