...
- 2026-08-09 CI correction: run `31320398601` failed only because Gallery required scrolling from compact Studio-derived `midnight`/`obsidian` skins. Replaced the skin-ID condition with actual content-overflow detection; AVX2 Editor rebuild, VST self-test, source/variant sync, and the full 20-skin gallery (5120 PNGs, zero warnings) passed locally. Fresh beta CI is pending.
