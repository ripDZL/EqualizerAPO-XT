...
- [ ] If requested, push/build/install the verified local Clarity-menu grouping follow-up from `codex/upstream-2471-integration`; it is not on `beta`, not released, and not installed.
