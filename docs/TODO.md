...
- [ ] Push the local final #265 VST3 editor slice and require its hosted CI/UI-gallery result before the manual multichannel VST3 acceptance; do not promote it to `beta` or `main` yet.
